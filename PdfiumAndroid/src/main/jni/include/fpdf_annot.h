...
DLLEXPORT FPDF_ANNOTATION STDCALL FPDFPage_CreateAnnot(FPDF_PAGE page, FPDF_ANNOTATION_SUBTYPE subtype);
...
DLLEXPORT FPDF_ANNOTATION STDCALL FPDFPage_GetAnnot(FPDF_PAGE page,
                                                            int index);
...
DLLEXPORT int STDCALL FPDFPage_GetAnnotIndex(FPDF_PAGE page,
...
DLLEXPORT FPDF_BOOL STDCALL FPDFPage_RemoveAnnot(FPDF_PAGE page,
                                                         int index);
...
DLLEXPORT int STDCALL FPDFAnnot_AddInkStroke(FPDF_ANNOTATION annot,
...
DLLEXPORT FPDF_BOOL STDCALL FPDFAnnot_GetLine(FPDF_ANNOTATION annot,
                                                      FS_POINTF* start,
                                                      FS_POINTF* end);
...
DLLEXPORT FPDF_BOOL STDCALL FPDFAnnot_SetBorder(FPDF_ANNOTATION annot,
...
DLLEXPORT int STDCALL FPDFAnnot_GetOptionCount(FPDF_FORMHANDLE hHandle,
                                                       FPDF_ANNOTATION annot);
...
DLLEXPORT FPDF_BOOL STDCALL FPDFAnnot_IsChecked(FPDF_FORMHANDLE hHandle,
                                                        FPDF_ANNOTATION annot);
...
DLLEXPORT FPDF_LINK STDCALL FPDFAnnot_GetLink(FPDF_ANNOTATION annot);
...
//
// Returns true if successful.
DLLEXPORT FPDF_BOOL STDCALL FPDFAnnot_SetURI(FPDF_ANNOTATION annot,
                                                     const char* uri);
...
DLLEXPORT FPDF_ATTACHMENT STDCALL
